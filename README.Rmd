...
I'll attempt to show some basic data ingestion, data preparation, visualization, and predictive modeling techniques in the process. I will use the _R_ programming language, along with _R Markdown_, for this document. 
...
```{r load_crude_oil, warning=FALSE, message=FALSE, tidy=TRUE}
...
```{r load_rest_of_data, warning=FALSE, message=FALSE, tidy=TRUE}
