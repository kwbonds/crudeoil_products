...
All code for this analysis can be found at: https://github.com/kwbonds/crude oil_products. Feel free to clone/fork and comment to me at kevin.w.bonds@gmail.com.
...
I'll load the data and do some quick formatting. Then I'll take a quick look and begin modeling the data and make predictions. Loading the individual Excel tabs in to tables and joining them into one big table and add Month-over_Month and Year-over-Year for later maybe. We may do additional work to add features late.
